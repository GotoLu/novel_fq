...
### 6. 群像轮转机制（ensemble_rotation）

长篇项目必须为主要配角建立群像轮转表，防止配角工具化。

| 字段 | 必填要求 |
|------|----------|
| 个人目标 | 角色自己想要什么，不能只服务主角 |
| 私线进度 | 每 5-10 章该角色的私线推进到哪里 |
| 利益冲突 | 角色与主角、反派或其他配角的利益摩擦 |
| 阶段高光 | 本阶段角色凭什么被读者记住 |
| 关系变化 | 与主角或核心人物的关系如何改变 |
| 退场/反转计划 | 角色何时退场、背叛、转化或承担代价 |

**轮转规则**：
- 主要配角连续 10 章没有欲望推进，判定为工具化风险。
- 配角高光必须推动主线、改变关系或制造新代价，禁止脱离主线自我感动。
- 群像轮转表必须与 `plot-architect` 的长篇资源账本同步。

---

### 7. 一致性检查 (check_consistency)
...
4. **一致性**：定期检查人物一致性
5. **成长空间**：主要人物要有成长弧线
6. **压力显形**：主要人物必须在失去、诱惑、误解、羞辱、两难中暴露真实欲望和弱点
7. **错误决策**：重要人物必须有会导致代价的错误决策倾向，禁止完美工具人
