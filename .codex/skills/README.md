...
1. 全局章节审查闸门：章节卡、正文和章节评估必须先完成读者沉浸式体验审查与上帝视角语境审查。
2. 创作质量闸门：执行 [创作质量优先级](./创作质量优先级.md) 中与当前任务相关的项目。
3. 系统协同闸门：前置资料完整、跨技能数据一致、下一步可执行。
4. 原创风险闸门：核心创意、设定、场景、正文和对话没有明显相似风险。
