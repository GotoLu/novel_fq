...
### 2.1 改稿分诊规则（revision_triage）

改稿必须先分诊，禁止上来就润色句子。

| 优先级 | 问题类型 | 处理原则 |
|--------|----------|----------|
| 1 | 结构问题 | 先修目标、冲突、代价、局面变化和主线因果 |
| 2 | 人物动机问题 | 先修欲望、选择、误判、弱点和行为逻辑 |
| 3 | 追读问题 | 先修钩子、章节接力、爽点链和期待管理 |
| 4 | 场景问题 | 再修空间压力、动作节拍、道具功能和感官 |
| 5 | 语言问题 | 最后修句式、节奏、标点和表达质感 |

**改稿边界声明**：
- 保留：必须保护的核心卖点、人物高光、关键伏笔、读者期待。
- 删除：重复信息、无功能描写、无代价胜利、无效对白。
- 增强：冲突强度、情绪代价、爽点链、章节接力。
- 禁止破坏：已建立设定、人物动机、伏笔回收、长篇资源账本。
