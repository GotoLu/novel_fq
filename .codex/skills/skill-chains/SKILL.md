---
name: "skill-chains"
description: "将全部小说写作技能组织为阶段化工作流。用于规划或执行从市场分析、创意生成、人物设计、情节架构、正文写作、质量评估、问题修复、原创性查重、进度追踪到发布完结的完整创作流程。"
---
...
3. 读取 `README.md` 确认全技能角色、五阶段执行链、数据流、阶段切换条件和失败回退。
...
10. 所有阶段状态、审计结果、查重结论和调整依据必须交给 `progress-tracker` 记录。
