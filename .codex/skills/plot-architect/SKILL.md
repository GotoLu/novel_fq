...
### P1 情节推进发动机（必须优先于事件罗列）

大纲的核心不是“安排事件”，而是连续改变人物处境。任何分卷、分章、场景大纲都必须使用以下推进卡：
...
| 主要阻碍 | 谁或什么阻止目标达成 |
| 冲突升级 | 本节点比上一节点更难在哪里 |
| 代价后果 | 人物推进后失去什么、暴露什么或承担什么风险 |
| 局面变化 | 关系、线索、压力、资源、认知至少一项如何改变 |
| 章末追读 | 读者读完后最想知道的具体问题 |

**淘汰规则**：
- 只写“主角调查案件”“反派出现”“获得线索”之类事件描述，不合格。
- 节点结束后人物处境没有变化，不合格。
- 连续三个节点只靠新线索推进、没有人物选择和代价，不合格。
- 伏笔只埋不制造当下戏剧压力，不合格。

### P5-P9 场景与章节接力设计

分章大纲和场景大纲必须补充以下两张卡，避免正文阶段变成临场补洞。

**场景调度卡**：

| 字段 | 必填要求 |
|------|----------|
| 场景空间 | 场景发生在哪里，空间如何限制人物行动 |
| 镜头顺序 | 读者先看见什么，后看见什么，最后被什么改变认知 |
| 动作节拍 | 人物用哪些动作推进冲突，而不是只靠对话说明 |
| 功能道具 | 哪个物件承担线索、误导、威胁、反转、幽默或情绪触发 |
| 主导感官 | 本场景优先使用哪一种感官形成记忆点 |
...
| 字段 | 必填要求 |
|------|----------|
| 压抑铺垫 | 谁被压、被误解、被羞辱或失去资源 |
| 读者预判 | 读者以为局面会如何发展 |
| 主角反制 | 主角用什么能力、判断或代价改写局面 |
| 公开见证 | 谁看见、谁误判、谁被打脸 |
| 即时回报 | 主角立刻获得什么收益 |
| 余波升级 | 胜利后引出什么更大麻烦 |
...
长篇规划必须在分卷大纲阶段建立以下控制表，防止中后期资源枯竭和连载疲软。

**长篇资源账本**：

| 资源 | 必填要求 |
|------|----------|
| 案件池 | 每个案件的类型、核心谜面、真相机制、差异点 |
| 冲突池 | 外部冲突、人物冲突、价值冲突、信息冲突的轮换计划 |
| 爽点池 | 打脸、破局、升级、揭穿、反杀、误判击穿等回报类型 |
| 关系变化池 | 每组重要关系的阶段变化和不可逆节点 |
| 伏笔库存 | 伏笔编号、埋设位置、误导功能、回收章节 |
| 反派压力曲线 | 阶段敌人的压迫方式、升级节点和反扑方式 |

**类型专门引擎**：

| 类型 | 必填机制 |
|------|----------|
| 悬疑 | 线索公平性、误导层级、嫌疑人动机矩阵、真相反转边界 |
| 喜剧 | 预期落空、身份错位、语言节拍、反差回收 |
| 爽文 | 压抑阈值、反制方式、公开见证、收益层级、余波升级 |

**卷级防塌卡**：

| 字段 | 必填要求 |
|------|----------|
| 阶段目标 | 本卷主角必须完成什么不可替代目标 |
| 阶段敌人 | 本卷最主要的压迫源是谁或什么 |
| 阶段谜题 | 本卷读者最想知道的核心问题 |
| 情绪主题 | 本卷主导情绪是什么，如何递进 |
| 爽点峰值 | 本卷最强回报出现在哪里 |
| 卷末反转 | 卷末如何改变主角处境或读者认知 |
| 疲劳预警 | 哪些套路、线索、冲突不能重复使用 |

### P16/P19 资产库与完结设计

长篇规划必须建立小说资产库，并在完结阶段使用完结设计表。

**小说资产库**：

| 资产 | 必填内容 |
|------|----------|
| 人物资产 | 口癖、行为习惯、禁忌、关系状态、阶段变化 |
| 世界资产 | 地点、机构、规则、时间线、势力关系 |
| 案件资产 | 线索、嫌疑人、证据、误导、真相、遗留影响 |
| 语言资产 | 风格声明、禁用词、常用幽默方式、标志性表达 |
| 伏笔资产 | 已埋、待回收、已回收、废弃、留白 |
| 道具资产 | 功能、出现章节、持有人、用途变化 |

**资产库规则**：
- 新增设定、线索、道具、口癖、伏笔、关系变化必须入库。
- 改稿前必须检查资产库，避免改掉已建立事实。
- 资产状态必须可追踪：新增、活跃、已回收、废弃、留白。
...
|------|----------|
| 主线偿付 | 核心承诺如何兑现 |
| 人物归宿 | 主要人物获得、失去或理解了什么 |
| 情绪债清算 | 读者等待的情绪回报如何完成 |
| 伏笔处理 | 哪些回收，哪些留白，哪些废弃 |
| 主题落点 | 全书最终表达的判断 |
| 续作空间 | 哪些余味可以延展，但不影响本书完整 |
| 烂尾风险 | 哪些问题不解决会伤害读者信任 |
