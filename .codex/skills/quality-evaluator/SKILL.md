...
- 未完成读者沉浸式体验审查或上帝视角语境审查。
- 未完成作者性格一致性审查，或正文落笔明显不符合本书作者性格声明且无偏离记录。
- 正文或人物对白出现“本章”“下一章”“阶段任务”“章节功能”“本阶段”等生产过程语汇。
- 正文提前泄露角色当下不可能知道的信息，或用旁白提前定性凶手、幕后者、案件机制、人物真实动机。
- 伏笔用全知语气替读者划重点，而不是落在可观察异常、道具、动作、措辞或记录上。
