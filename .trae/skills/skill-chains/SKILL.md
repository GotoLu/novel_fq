...
当任务跨越多个写作技能，或需要端到端创作流程时，使用本技能。本技能必须整合 `.trae/skills/` 下全部相关技能，而不是只执行 P0-P19 质量条目。
...
11. 保持 `.trae/rules/project_rules.md` 中的项目原则：先客观分析，再给出依据最充分的决策。
